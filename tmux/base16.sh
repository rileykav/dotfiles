...
tm_exdisk="#[fg=$base08, bg=$base00] #(osascript ~/.dotfiles/tmux/seagate-usage.scpt)"
#tm_weeknum="#[fg=$base08, bg=$base00] Week #(osascript ~/.dotfiles/tmux/weeknum.scpt)"
...
set -g status-right "$tm_tunes$tm_music $tm_battery $tm_disk $tm_exdisk $tm_weeknum $tm_date $tm_host"
